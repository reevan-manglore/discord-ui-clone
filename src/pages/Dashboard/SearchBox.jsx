...
function SearchBox() {
  ...
  return (
    <section className="px-2  h-full overflow-hidden flex flex-col justify-start justify-items-start  ">
        ...
        <QuickSearchTile icon={friends} label = "Friends" isSelected={selectedTab === "friends"}  onPressed = {()=>setSelectedTab("friends")}/>
        <QuickSearchTile icon={stageDiscovery} label = "Stage Discovery" isSelected={selectedTab === "stageDiscovery"} onPressed = {()=>setSelectedTab("stageDiscovery")}/>
        <QuickSearchTile icon={nitro} label = "Nitro" isSelected={selectedTab === "nitro"} onPressed = {()=>setSelectedTab("nitro")}/>
